...
#############################################################################
#############################################################################
#par=np.arange(0.05, 0.4,0.05)#14
par=np.arange(1,2,1)#14
#par=[1, 10, 100, 1000, 10000]
#par=[160, 256, 320, 512, 720, 1024]
#par=[72, 96]
#par=[32,64, 96, 128, 256, 512]
#par=[4, 32]#, 48, 64]#, 72, 96]#, 128, 160, 256, 320, 512, 720, 1024]
...
opt_runshrNN=np.zeros((1,len(par),4))
opt_runsraNN=np.zeros((2,len(par),4))
opt_runsciaNN=np.zeros((2,len(par),4))
opt_runshbNN=np.zeros((2,len(par),4))
opt_runsslrNN=np.zeros((3,len(par),4))
opt_runswrNN=np.zeros((3,len(par),4))
opt_runsag030NN=np.zeros((7,len(par),4))
opt_runsag060NN=np.zeros((7,len(par),4))
opt_runsag180NN=np.zeros((7,len(par),4))
opt_runsag120NN=np.zeros((7,len(par),4))
opt_runsdf030NN=np.zeros((3,len(par),4))
opt_runsdf060NN=np.zeros((3,len(par),4))
opt_runsdf180NN=np.zeros((3,len(par),4))
opt_runsdf120NN=np.zeros((3,len(par),4))
...
for opt_ in range(len(par)):
    opt=par[opt_]
    dropout=0.05#1*int(opt)

    input_dim = 4*10
    output_dim = 1
    num_epochs = 80
    layer_dim = 1
    learning_rate = 0.0007#*int(opt) #0r 0.0007
    batch_size =128#int(opt)
    test_split =0# 0.0000001
    decay_rate=0#.1#*int(opt)#0.4, 0.7
    decay_steps=10000
    momentum=0.8
    samplefreq=10
    Ts=int(samplefreq*1*1)#*int(opt)
    seq_dim=int(1*(10/Ts))#*int(opt)#12 FOR LSTM, 10 FOR GRU,12 for idnn
...
#    AGdat5=[V_Vfb02b]#needs improvement
#    AGdat6=[V_Vfb02g]#needs improvement
#   
#    DFdat1=[V_Vfa01]
#    DFdat2=[V_Vfb01c]    
    AGdat1=[V_Vtb3]
    ...
    DFdat1=[V_St6]#good 5.5
    DFdat2=[V_St7[:17000]]#needs improvement vta29, vta1a
    DFdat3=[V_S3a]#needs improvement vta29, vta1a
...
#    gtag7,itag7,xtag7, ytag7=data_process13t(AGdat7, seq_dim, input_dim, output_dim, Ts, Acc1_bias, Acc2_bias, gyro1_bias, batch_size, amx, amn, dimx, dimn, dgmx, dgmn, gymx, gymn, Z, mode)
    ...
    'array creation to store  maximum NN estimated error for each scenario after each full training. '
    aeps_runshrNN=np.zeros((int(number_of_runs),4))
    aeps_runsra_1NN=np.zeros((int(number_of_runs),4))
    aeps_runsra_2NN=np.zeros((int(number_of_runs),4))
    aeps_runscia_1NN=np.zeros((int(number_of_runs),4))
    aeps_runscia_2NN=np.zeros((int(number_of_runs),4))
    aeps_runshb_1NN=np.zeros((int(number_of_runs),4))
    aeps_runshb_2NN=np.zeros((int(number_of_runs),4))        
    aeps_runsslr_1NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsslr_2NN=np.zeros((int(number_of_runs),4))     
    aeps_runsslr_3NN=np.zeros((int(number_of_runs),4)) 
    aeps_runswr_1NN=np.zeros((int(number_of_runs),4))
    aeps_runswr_2NN=np.zeros((int(number_of_runs),4))    
    aeps_runswr_3NN=np.zeros((int(number_of_runs),4))    
    aeps_runsag30_1NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag30_2NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag30_3NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag30_4NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag30_5NN=np.zeros((int(number_of_runs),4))     
    aeps_runsag30_6NN=np.zeros((int(number_of_runs),4)) 
#    aeps_runsag30_7NN=np.zeros((int(number_of_runs),4)) 
    
    aeps_runsag60_1NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag60_2NN=np.zeros((int(number_of_runs),4))
    aeps_runsag60_3NN=np.zeros((int(number_of_runs),4))
    aeps_runsag60_4NN=np.zeros((int(number_of_runs),4))
    aeps_runsag60_5NN=np.zeros((int(number_of_runs),4))    
    aeps_runsag60_6NN=np.zeros((int(number_of_runs),4))   
#    aeps_runsag60_7NN=np.zeros((int(number_of_runs),4))
    
    aeps_runsag90_1NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag90_2NN=np.zeros((int(number_of_runs),4))     
    aeps_runsag90_3NN=np.zeros((int(number_of_runs),4))     
    aeps_runsag90_4NN=np.zeros((int(number_of_runs),4))     
    aeps_runsag90_5NN=np.zeros((int(number_of_runs),4))     
    aeps_runsag90_6NN=np.zeros((int(number_of_runs),4)) 
#    aeps_runsag90_7NN=np.zeros((int(number_of_runs),4)) 
       
    aeps_runsag120_1NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag120_2NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag120_3NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag120_4NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag120_5NN=np.zeros((int(number_of_runs),4))     
    aeps_runsag120_6NN=np.zeros((int(number_of_runs),4)) 
#    aeps_runsag120_7NN=np.zeros((int(number_of_runs),4))
    
    aeps_runsag180_1NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag180_2NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag180_3NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag180_4NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsag180_5NN=np.zeros((int(number_of_runs),4))     
    aeps_runsag180_6NN=np.zeros((int(number_of_runs),4))  
#    aeps_runsag180_7NN=np.zeros((int(number_of_runs),4)) 
    
    aeps_runsdf30_1NN=np.zeros((int(number_of_runs),4))
    aeps_runsdf30_2NN=np.zeros((int(number_of_runs),4))
    aeps_runsdf30_3NN=np.zeros((int(number_of_runs),4))
    
    aeps_runsdf60_1NN=np.zeros((int(number_of_runs),4))
    aeps_runsdf60_2NN=np.zeros((int(number_of_runs),4))
    aeps_runsdf60_3NN=np.zeros((int(number_of_runs),4))
    
    aeps_runsdf90_1NN=np.zeros((int(number_of_runs),4))
    aeps_runsdf90_2NN=np.zeros((int(number_of_runs),4))    
    aeps_runsdf90_3NN=np.zeros((int(number_of_runs),4))  
    
    aeps_runsdf120_1NN=np.zeros((int(number_of_runs),4))
    aeps_runsdf120_2NN=np.zeros((int(number_of_runs),4))
    aeps_runsdf120_3NN=np.zeros((int(number_of_runs),4))
    
    aeps_runsdf180_1NN=np.zeros((int(number_of_runs),4))
    aeps_runsdf180_2NN=np.zeros((int(number_of_runs),4)) 
    aeps_runsdf180_3NN=np.zeros((int(number_of_runs),4)) 
    
    'array creation to store  maximum INS physical model error for each scenario after each full training. '
    aeps_runshrINS_DR=np.zeros((int(number_of_runs),4))
    
    aeps_runsra_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsra_2INS_DR=np.zeros((int(number_of_runs),4))
    
    aeps_runscia_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runscia_2INS_DR=np.zeros((int(number_of_runs),4))    
    
    aeps_runshb_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runshb_2INS_DR=np.zeros((int(number_of_runs),4))

    
    aeps_runsslr_1INS_DR=np.zeros((int(number_of_runs),4)) 
    aeps_runsslr_2INS_DR=np.zeros((int(number_of_runs),4)) 
    aeps_runsslr_3INS_DR=np.zeros((int(number_of_runs),4)) 
    
    aeps_runswr_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runswr_2INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runswr_3INS_DR=np.zeros((int(number_of_runs),4))
    
    aeps_runsag30_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag30_2INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag30_3INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag30_4INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag30_5INS_DR=np.zeros((int(number_of_runs),4))    
    aeps_runsag30_6INS_DR=np.zeros((int(number_of_runs),4))
#    aeps_runsag30_7INS_DR=np.zeros((int(number_of_runs),4))
    
    aeps_runsag60_1INS_DR=np.zeros((int(number_of_runs),4))  
    aeps_runsag60_2INS_DR=np.zeros((int(number_of_runs),4)) 
    aeps_runsag60_3INS_DR=np.zeros((int(number_of_runs),4)) 
    aeps_runsag60_4INS_DR=np.zeros((int(number_of_runs),4)) 
    aeps_runsag60_5INS_DR=np.zeros((int(number_of_runs),4)) 
    aeps_runsag60_6INS_DR=np.zeros((int(number_of_runs),4)) 
#    aeps_runsag60_7INS_DR=np.zeros((int(number_of_runs),4)) 
    
    aeps_runsag90_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag90_2INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag90_3INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag90_4INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag90_5INS_DR=np.zeros((int(number_of_runs),4))    
    aeps_runsag90_6INS_DR=np.zeros((int(number_of_runs),4))
#    aeps_runsag90_7INS_DR=np.zeros((int(number_of_runs),4))
    
    aeps_runsag120_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag120_2INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag120_3INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag120_4INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag120_5INS_DR=np.zeros((int(number_of_runs),4))    
    aeps_runsag120_6INS_DR=np.zeros((int(number_of_runs),4))
#    aeps_runsag120_7INS_DR=np.zeros((int(number_of_runs),4))
    
    aeps_runsag180_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag180_2INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag180_3INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag180_4INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsag180_5INS_DR=np.zeros((int(number_of_runs),4))    
    aeps_runsag180_6INS_DR=np.zeros((int(number_of_runs),4))
#    aeps_runsag180_7INS_DR=np.zeros((int(number_of_runs),4))
    
    aeps_runsdf30_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsdf30_2INS_DR=np.zeros((int(number_of_runs),4))        
    aeps_runsdf30_3INS_DR=np.zeros((int(number_of_runs),4)) 
    
    aeps_runsdf60_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsdf60_2INS_DR=np.zeros((int(number_of_runs),4))    
    aeps_runsdf60_3INS_DR=np.zeros((int(number_of_runs),4)) 
    
    aeps_runsdf90_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsdf90_2INS_DR=np.zeros((int(number_of_runs),4))    
    aeps_runsdf90_3INS_DR=np.zeros((int(number_of_runs),4)) 
    
    aeps_runsdf120_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsdf120_2INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsdf120_3INS_DR=np.zeros((int(number_of_runs),4))
    
    aeps_runsdf180_1INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsdf180_2INS_DR=np.zeros((int(number_of_runs),4))
    aeps_runsdf180_3INS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runshrNN=np.zeros((int(number_of_runs),4))
    cae_runsra_1NN=np.zeros((int(number_of_runs),4))
    cae_runsra_2NN=np.zeros((int(number_of_runs),4))
    cae_runscia_1NN=np.zeros((int(number_of_runs),4))
    cae_runscia_2NN=np.zeros((int(number_of_runs),4))
    cae_runshb_1NN=np.zeros((int(number_of_runs),4))
    cae_runshb_2NN=np.zeros((int(number_of_runs),4))        
    cae_runsslr_1NN=np.zeros((int(number_of_runs),4)) 
    cae_runsslr_2NN=np.zeros((int(number_of_runs),4))     
    cae_runsslr_3NN=np.zeros((int(number_of_runs),4)) 
    cae_runswr_1NN=np.zeros((int(number_of_runs),4))
    cae_runswr_2NN=np.zeros((int(number_of_runs),4))    
    cae_runswr_3NN=np.zeros((int(number_of_runs),4))    
    cae_runsag30_1NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag30_2NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag30_3NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag30_4NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag30_5NN=np.zeros((int(number_of_runs),4))     
    cae_runsag30_6NN=np.zeros((int(number_of_runs),4)) 
#    cae_runsag30_7NN=np.zeros((int(number_of_runs),4)) 
    
    cae_runsag60_1NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag60_2NN=np.zeros((int(number_of_runs),4))
    cae_runsag60_3NN=np.zeros((int(number_of_runs),4))
    cae_runsag60_4NN=np.zeros((int(number_of_runs),4))
    cae_runsag60_5NN=np.zeros((int(number_of_runs),4))    
    cae_runsag60_6NN=np.zeros((int(number_of_runs),4))  
#    cae_runsag60_7NN=np.zeros((int(number_of_runs),4))     
    
    cae_runsag90_1NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag90_2NN=np.zeros((int(number_of_runs),4))     
    cae_runsag90_3NN=np.zeros((int(number_of_runs),4))     
    cae_runsag90_4NN=np.zeros((int(number_of_runs),4))     
    cae_runsag90_5NN=np.zeros((int(number_of_runs),4))     
    cae_runsag90_6NN=np.zeros((int(number_of_runs),4))  
#    cae_runsag90_7NN=np.zeros((int(number_of_runs),4)) 
      
    cae_runsag120_1NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag120_2NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag120_3NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag120_4NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag120_5NN=np.zeros((int(number_of_runs),4))     
    cae_runsag120_6NN=np.zeros((int(number_of_runs),4)) 
#    cae_runsag120_7NN=np.zeros((int(number_of_runs),4)) 
    
    cae_runsag180_1NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag180_2NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag180_3NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag180_4NN=np.zeros((int(number_of_runs),4)) 
    cae_runsag180_5NN=np.zeros((int(number_of_runs),4))     
    cae_runsag180_6NN=np.zeros((int(number_of_runs),4))
#    cae_runsag180_7NN=np.zeros((int(number_of_runs),4))
    
    cae_runsdf30_1NN=np.zeros((int(number_of_runs),4))
    cae_runsdf30_2NN=np.zeros((int(number_of_runs),4))
    cae_runsdf30_3NN=np.zeros((int(number_of_runs),4))
    
    cae_runsdf60_1NN=np.zeros((int(number_of_runs),4))
    cae_runsdf60_2NN=np.zeros((int(number_of_runs),4))
    cae_runsdf60_3NN=np.zeros((int(number_of_runs),4))
    
    cae_runsdf90_1NN=np.zeros((int(number_of_runs),4))
    cae_runsdf90_2NN=np.zeros((int(number_of_runs),4))    
    cae_runsdf90_3NN=np.zeros((int(number_of_runs),4))   
    
    cae_runsdf120_1NN=np.zeros((int(number_of_runs),4))
    cae_runsdf120_2NN=np.zeros((int(number_of_runs),4))
    cae_runsdf120_3NN=np.zeros((int(number_of_runs),4))
    
    cae_runsdf180_1NN=np.zeros((int(number_of_runs),4))
    cae_runsdf180_2NN=np.zeros((int(number_of_runs),4))
    cae_runsdf180_3NN=np.zeros((int(number_of_runs),4))
    
    'array creation to store  maximum INS physical model error for each scenario after each full training. '
    cae_runshrINS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runsra_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsra_2INS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runscia_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runscia_2INS_DR=np.zeros((int(number_of_runs),4))    
    
    cae_runshb_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runshb_2INS_DR=np.zeros((int(number_of_runs),4))

    
    cae_runsslr_1INS_DR=np.zeros((int(number_of_runs),4)) 
    cae_runsslr_2INS_DR=np.zeros((int(number_of_runs),4)) 
    cae_runsslr_3INS_DR=np.zeros((int(number_of_runs),4)) 
    
    cae_runswr_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runswr_2INS_DR=np.zeros((int(number_of_runs),4))
    cae_runswr_3INS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runsag30_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag30_2INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag30_3INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag30_4INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag30_5INS_DR=np.zeros((int(number_of_runs),4))    
    cae_runsag30_6INS_DR=np.zeros((int(number_of_runs),4))
#    cae_runsag30_7INS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runsag60_1INS_DR=np.zeros((int(number_of_runs),4))  
    cae_runsag60_2INS_DR=np.zeros((int(number_of_runs),4)) 
    cae_runsag60_3INS_DR=np.zeros((int(number_of_runs),4)) 
    cae_runsag60_4INS_DR=np.zeros((int(number_of_runs),4)) 
    cae_runsag60_5INS_DR=np.zeros((int(number_of_runs),4)) 
    cae_runsag60_6INS_DR=np.zeros((int(number_of_runs),4)) 
#    cae_runsag60_7INS_DR=np.zeros((int(number_of_runs),4)) 
    
    cae_runsag90_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag90_2INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag90_3INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag90_4INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag90_5INS_DR=np.zeros((int(number_of_runs),4))    
    cae_runsag90_6INS_DR=np.zeros((int(number_of_runs),4))
#    cae_runsag90_7INS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runsag120_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag120_2INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag120_3INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag120_4INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag120_5INS_DR=np.zeros((int(number_of_runs),4))    
    cae_runsag120_6INS_DR=np.zeros((int(number_of_runs),4))
#    cae_runsag120_7INS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runsag180_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag180_2INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag180_3INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag180_4INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsag180_5INS_DR=np.zeros((int(number_of_runs),4))    
    cae_runsag180_6INS_DR=np.zeros((int(number_of_runs),4))
#    cae_runsag180_7INS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runsdf30_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsdf30_2INS_DR=np.zeros((int(number_of_runs),4))        
    cae_runsdf30_3INS_DR=np.zeros((int(number_of_runs),4))  
    
    cae_runsdf60_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsdf60_2INS_DR=np.zeros((int(number_of_runs),4))    
    cae_runsdf60_3INS_DR=np.zeros((int(number_of_runs),4)) 
    
    cae_runsdf90_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsdf90_2INS_DR=np.zeros((int(number_of_runs),4))    
    cae_runsdf90_3INS_DR=np.zeros((int(number_of_runs),4)) 
    
    cae_runsdf120_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsdf120_2INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsdf120_3INS_DR=np.zeros((int(number_of_runs),4))
    
    cae_runsdf180_1INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsdf180_2INS_DR=np.zeros((int(number_of_runs),4))
    cae_runsdf180_3INS_DR=np.zeros((int(number_of_runs),4))
...
#    crse_runsag30_7NN=np.zeros((int(number_of_runs),4)) 
...
#    crse_runsag60_7NN=np.zeros((int(number_of_runs),4)) 
    
    crse_runsag90_1NN=np.zeros((int(number_of_runs),4)) 
    crse_runsag90_2NN=np.zeros((int(number_of_runs),4))     
    crse_runsag90_3NN=np.zeros((int(number_of_runs),4))     
    crse_runsag90_4NN=np.zeros((int(number_of_runs),4))     
    crse_runsag90_5NN=np.zeros((int(number_of_runs),4))     
    crse_runsag90_6NN=np.zeros((int(number_of_runs),4))  
#    crse_runsag90_7NN=np.zeros((int(number_of_runs),4)) 
...
#    crse_runsag120_7NN=np.zeros((int(number_of_runs),4)) 
...
#    crse_runsag180_7NN=np.zeros((int(number_of_runs),4))
    ...
    crse_runsdf90_1NN=np.zeros((int(number_of_runs),4))
    crse_runsdf90_2NN=np.zeros((int(number_of_runs),4))    
    crse_runsdf90_3NN=np.zeros((int(number_of_runs),4)) 
...
#    crse_runsag30_7INS_DR=np.zeros((int(number_of_runs),4))
...
#    crse_runsag60_7INS_DR=np.zeros((int(number_of_runs),4)) 
...
#    crse_runsag90_7INS_DR=np.zeros((int(number_of_runs),4))
...
#    crse_runsag120_7INS_DR=np.zeros((int(number_of_runs),4))
...
#    crse_runsag180_7INS_DR=np.zeros((int(number_of_runs),4))
    ...
    for nfr in range(number_of_runs):
        ...
        # regress.save('WhONet3_Model'+ str(nfr)+'.h5')   
#        regress.save('my_model.h5') 
#        Run_time=0
#        regress=keras.models.load_model("my_model.h5")    #keras.models.load_model("whlspd5.h5")      
        ...
        '30s outage'   #cae is wrong for INS
...
#        dist_travldag7_30s, perf_metrag7_crsep30s, perf_metrag7_crsedr30s, perf_metrag7_caep30s, perf_metrag7_caedr30s,perf_metrag7_aepsp30s, perf_metrag7_aepsdr30s, newPpredsag7_30s, insag7_30s, gpsag7_30s=predictcs(xtag7,ytag7, itag7, gtag7,regress, seq_dim, input_dim, mode, Ts, dgmx, dgmn, Z, 'Agrressive driving 120s Outage V_Vfb02g',outage2)   
        ...
        '60s outage'   #cae is wrong for INS
...
#        dist_travldag7_60s, perf_metrag7_crsep60s, perf_metrag7_crsedr60s, perf_metrag7_caep60s, perf_metrag7_caedr60s,perf_metrag7_aepsp60s, perf_metrag7_aepsdr60s, newPpredsag7_60s, insag7_60s, gpsag6_60s=predictcs(xtag7,ytag7, itag7, gtag7,regress, seq_dim, input_dim, mode, Ts, dgmx, dgmn, Z, 'Agrressive driving 120s Outage V_Vfb02g',outage3)   
        ...
        '90s outage'   #cae is wrong for INS
...
#        dist_travldag7_90s, perf_metrag7_crsep90s, perf_metrag7_crsedr90s, perf_metrag7_caep90s, perf_metrag7_caedr90s,perf_metrag7_aepsp90s, perf_metrag7_aepsdr90s, newPpredsag7_90s, insag7_90s, gpsag7_90s=predictcs(xtag7,ytag7, itag7, gtag7,regress, seq_dim, input_dim, mode, Ts, dgmx, dgmn, Z, 'Agrressive driving 120s Outage V_Vfb02g',outage4)   
        ...
        '120s outage'   #cae is wrong for INS
...
#        dist_travldag7_120s, perf_metrag7_crsep120s, perf_metrag7_crsedr120s, perf_metrag7_caep120s, perf_metrag7_caedr120s,perf_metrag7_aepsp120s, perf_metrag7_aepsdr120s, newPpredsag7_120s, insag7_120s, gpsag7_120s=predictcs(xtag7,ytag7, itag7, gtag7,regress, seq_dim, input_dim, mode, Ts, dgmx, dgmn, Z, 'Agrressive driving 120s Outage V_Vfb02g',outage5)   
        ...
        '180s outage'   #cae is wrong for INS
...
#        dist_travldag7_180s, perf_metrag7_crsep180s, perf_metrag7_crsedr180s, perf_metrag7_caep180s, perf_metrag7_caedr180s,perf_metrag7_aepsp180s, perf_metrag7_aepsdr180s, newPpredsag7_180s, insag7_180s, gpsag7_180s=predictcs(xtag7,ytag7, itag7, gtag7,regress, seq_dim, input_dim, mode, Ts, dgmx, dgmn, Z, 'Agrressive driving 180s Outage V_Vfb02g',outage6)   
...
#        crse_runsag30_7NN[nfr]=perf_metrag7_crsep30s[:]
...
#        crse_runsag60_7NN[nfr]=perf_metrag7_crsep60s[:] 
...
#        crse_runsag90_7NN[nfr]=perf_metrag7_crsep90s[:]  
...
#        crse_runsag120_7NN[nfr]=perf_metrag7_crsep120s[:] 
...
#        crse_runsag180_7NN[nfr]=perf_metrag7_crsep180s[:]
...
#        cae_runsag180_7INS_DR[nfr]=perf_metrag7_caedr180s[:]  
        ...
        aeps_runshrNN[nfr]=perf_metrhr_aepspcs[:]
        
        aeps_runsra_1NN[nfr]=perf_metrra1_aepspcs[:]  
        aeps_runsra_2NN[nfr]=perf_metrra2_aepspcs[:]         
                
        aeps_runscia_1NN[nfr]=perf_metrcia1_aepspcs[:] 
        aeps_runscia_2NN[nfr]=perf_metrcia2_aepspcs[:]         
        
        aeps_runshb_1NN[nfr]=perf_metrhb1_aepspcs[:]
        aeps_runshb_2NN[nfr]=perf_metrhb2_aepspcs[:]        
        
        aeps_runsslr_1NN[nfr]=perf_metrslr1_aepspcs[:]  
        aeps_runsslr_2NN[nfr]=perf_metrslr2_aepspcs[:]         
        aeps_runsslr_3NN[nfr]=perf_metrslr3_aepspcs[:] 
        
        aeps_runswr_1NN[nfr]=perf_metrwr1_aepspcs[:]
        aeps_runswr_2NN[nfr]=perf_metrwr2_aepspcs[:]        
        aeps_runswr_3NN[nfr]=perf_metrwr3_aepspcs[:]        
        
        aeps_runsag30_1NN[nfr]=perf_metrag1_aepsp30s[:]
        aeps_runsag30_2NN[nfr]=perf_metrag2_aepsp30s[:]        
        aeps_runsag30_3NN[nfr]=perf_metrag3_aepsp30s[:]        
        aeps_runsag30_4NN[nfr]=perf_metrag4_aepsp30s[:]        
        aeps_runsag30_5NN[nfr]=perf_metrag5_aepsp30s[:] 
        aeps_runsag30_6NN[nfr]=perf_metrag6_aepsp30s[:]        
#        aeps_runsag30_7NN[nfr]=perf_metrag7_aepsp30s[:] 
        
        aeps_runsag60_1NN[nfr]=perf_metrag1_aepsp60s[:]
        aeps_runsag60_2NN[nfr]=perf_metrag2_aepsp60s[:]        
        aeps_runsag60_3NN[nfr]=perf_metrag3_aepsp60s[:]        
        aeps_runsag60_4NN[nfr]=perf_metrag4_aepsp60s[:]        
        aeps_runsag60_5NN[nfr]=perf_metrag5_aepsp60s[:] 
        aeps_runsag60_6NN[nfr]=perf_metrag6_aepsp60s[:]        
#        aeps_runsag60_7NN[nfr]=perf_metrag7_aepsp60s[:] 

        aeps_runsag90_1NN[nfr]=perf_metrag1_aepsp90s[:]
        aeps_runsag90_2NN[nfr]=perf_metrag2_aepsp90s[:]        
        aeps_runsag90_3NN[nfr]=perf_metrag3_aepsp90s[:]        
        aeps_runsag90_4NN[nfr]=perf_metrag4_aepsp90s[:]        
        aeps_runsag90_5NN[nfr]=perf_metrag5_aepsp90s[:]   
        aeps_runsag90_6NN[nfr]=perf_metrag6_aepsp90s[:]        
#        aeps_runsag90_7NN[nfr]=perf_metrag7_aepsp90s[:] 
        
        aeps_runsag120_1NN[nfr]=perf_metrag1_aepsp120s[:]
        aeps_runsag120_2NN[nfr]=perf_metrag2_aepsp120s[:]        
        aeps_runsag120_3NN[nfr]=perf_metrag3_aepsp120s[:]        
        aeps_runsag120_4NN[nfr]=perf_metrag4_aepsp120s[:]        
        aeps_runsag120_5NN[nfr]=perf_metrag5_aepsp120s[:] 
        aeps_runsag120_6NN[nfr]=perf_metrag6_aepsp120s[:]        
#        aeps_runsag120_7NN[nfr]=perf_metrag7_aepsp120s[:]
        
        aeps_runsag180_1NN[nfr]=perf_metrag1_aepsp180s[:]
        aeps_runsag180_2NN[nfr]=perf_metrag2_aepsp180s[:]        
        aeps_runsag180_3NN[nfr]=perf_metrag3_aepsp180s[:]        
        aeps_runsag180_4NN[nfr]=perf_metrag4_aepsp180s[:]        
        aeps_runsag180_5NN[nfr]=perf_metrag5_aepsp180s[:] 
        aeps_runsag180_6NN[nfr]=perf_metrag6_aepsp180s[:]        
#        aeps_runsag180_7NN[nfr]=perf_metrag7_aepsp180s[:]
        
        aeps_runsdf30_1NN[nfr]=perf_metrdf1_aepsp30s[:]
        aeps_runsdf30_2NN[nfr]=perf_metrdf2_aepsp30s[:]               
        aeps_runsdf30_3NN[nfr]=perf_metrdf3_aepsp30s[:]  
        
        aeps_runsdf60_1NN[nfr]=perf_metrdf1_aepsp60s[:]
        aeps_runsdf60_2NN[nfr]=perf_metrdf2_aepsp60s[:]               
        aeps_runsdf60_3NN[nfr]=perf_metrdf3_aepsp60s[:] 
        
        aeps_runsdf90_1NN[nfr]=perf_metrdf1_aepsp90s[:]
        aeps_runsdf90_2NN[nfr]=perf_metrdf2_aepsp90s[:]               
        aeps_runsdf90_3NN[nfr]=perf_metrdf3_aepsp90s[:]   
        
        aeps_runsdf120_1NN[nfr]=perf_metrdf1_aepsp120s[:]   
        aeps_runsdf120_2NN[nfr]=perf_metrdf2_aepsp120s[:]
        aeps_runsdf120_3NN[nfr]=perf_metrdf3_aepsp120s[:]
        
        aeps_runsdf180_1NN[nfr]=perf_metrdf1_aepsp180s[:]   
        aeps_runsdf180_2NN[nfr]=perf_metrdf2_aepsp180s[:]
        aeps_runsdf180_3NN[nfr]=perf_metrdf3_aepsp180s[:]
        
        aeps_runshrINS_DR[nfr]=perf_metrhr_aepsdrcs[:]
        
        
        aeps_runsra_1INS_DR[nfr]=perf_metrra1_aepsdrcs[:] 
        aeps_runsra_2INS_DR[nfr]=perf_metrra2_aepsdrcs[:]         
        
        aeps_runscia_1INS_DR[nfr]=perf_metrcia1_aepsdrcs[:]
        aeps_runscia_2INS_DR[nfr]=perf_metrcia2_aepsdrcs[:]        
        
        aeps_runshb_1INS_DR[nfr]=perf_metrhb1_aepsdrcs[:]
        aeps_runshb_2INS_DR[nfr]=perf_metrhb2_aepsdrcs[:]        
        
        aeps_runsslr_1INS_DR[nfr]=perf_metrslr1_aepsdrcs[:] 
        aeps_runsslr_2INS_DR[nfr]=perf_metrslr2_aepsdrcs[:]         
        aeps_runsslr_3INS_DR[nfr]=perf_metrslr3_aepsdrcs[:]         
        
        aeps_runswr_1INS_DR[nfr]=perf_metrwr1_aepsdrcs[:]
        aeps_runswr_2INS_DR[nfr]=perf_metrwr2_aepsdrcs[:]        
        aeps_runswr_3INS_DR[nfr]=perf_metrwr3_aepsdrcs[:]

        aeps_runsag30_1INS_DR[nfr]=perf_metrag1_aepsdr30s[:]
        aeps_runsag30_2INS_DR[nfr]=perf_metrag2_aepsdr30s[:]        
        aeps_runsag30_3INS_DR[nfr]=perf_metrag3_aepsdr30s[:]        
        aeps_runsag30_4INS_DR[nfr]=perf_metrag4_aepsdr30s[:]        
        aeps_runsag30_5INS_DR[nfr]=perf_metrag5_aepsdr30s[:]
        aeps_runsag30_6INS_DR[nfr]=perf_metrag6_aepsdr30s[:]        
#        aeps_runsag30_7INS_DR[nfr]=perf_metrag7_aepsdr30s[:] 
        
        aeps_runsag60_1INS_DR[nfr]=perf_metrag1_aepsdr60s[:]
        aeps_runsag60_2INS_DR[nfr]=perf_metrag2_aepsdr60s[:]        
        aeps_runsag60_3INS_DR[nfr]=perf_metrag3_aepsdr60s[:]        
        aeps_runsag60_4INS_DR[nfr]=perf_metrag4_aepsdr60s[:]        
        aeps_runsag60_5INS_DR[nfr]=perf_metrag5_aepsdr60s[:]
        aeps_runsag60_6INS_DR[nfr]=perf_metrag6_aepsdr60s[:]        
#        aeps_runsag60_7INS_DR[nfr]=perf_metrag7_aepsdr60s[:] 
        
        aeps_runsag90_1INS_DR[nfr]=perf_metrag1_aepsdr90s[:]
        aeps_runsag90_2INS_DR[nfr]=perf_metrag2_aepsdr90s[:]        
        aeps_runsag90_3INS_DR[nfr]=perf_metrag3_aepsdr90s[:]        
        aeps_runsag90_4INS_DR[nfr]=perf_metrag4_aepsdr90s[:]
        aeps_runsag90_5INS_DR[nfr]=perf_metrag5_aepsdr90s[:]
        aeps_runsag90_6INS_DR[nfr]=perf_metrag6_aepsdr90s[:]        
#        aeps_runsag90_7INS_DR[nfr]=perf_metrag7_aepsdr90s[:] 
        
        aeps_runsag120_1INS_DR[nfr]=perf_metrag1_aepsdr120s[:]
        aeps_runsag120_2INS_DR[nfr]=perf_metrag2_aepsdr120s[:]        
        aeps_runsag120_3INS_DR[nfr]=perf_metrag3_aepsdr120s[:]        
        aeps_runsag120_4INS_DR[nfr]=perf_metrag4_aepsdr120s[:]
        aeps_runsag120_5INS_DR[nfr]=perf_metrag5_aepsdr120s[:]
        aeps_runsag120_6INS_DR[nfr]=perf_metrag6_aepsdr120s[:]        
#        aeps_runsag120_7INS_DR[nfr]=perf_metrag7_aepsdr120s[:]   
        
        aeps_runsag180_1INS_DR[nfr]=perf_metrag1_aepsdr180s[:]
        aeps_runsag180_2INS_DR[nfr]=perf_metrag2_aepsdr180s[:]        
        aeps_runsag180_3INS_DR[nfr]=perf_metrag3_aepsdr180s[:]        
        aeps_runsag180_4INS_DR[nfr]=perf_metrag4_aepsdr180s[:]
        aeps_runsag180_5INS_DR[nfr]=perf_metrag5_aepsdr180s[:]
        aeps_runsag180_6INS_DR[nfr]=perf_metrag6_aepsdr180s[:]        
#        aeps_runsag180_7INS_DR[nfr]=perf_metrag7_aepsdr180s[:] 
        
        aeps_runsdf30_1INS_DR[nfr]=perf_metrdf1_aepsdr30s[:]
        aeps_runsdf30_2INS_DR[nfr]=perf_metrdf2_aepsdr30s[:]              
        aeps_runsdf30_3INS_DR[nfr]=perf_metrdf3_aepsdr30s[:] 
        
        aeps_runsdf60_1INS_DR[nfr]=perf_metrdf1_aepsdr60s[:]
        aeps_runsdf60_2INS_DR[nfr]=perf_metrdf2_aepsdr60s[:]               
        aeps_runsdf60_3INS_DR[nfr]=perf_metrdf3_aepsdr60s[:] 
        
        aeps_runsdf90_1INS_DR[nfr]=perf_metrdf1_aepsdr90s[:]
        aeps_runsdf90_2INS_DR[nfr]=perf_metrdf2_aepsdr90s[:]                
        aeps_runsdf90_3INS_DR[nfr]=perf_metrdf3_aepsdr90s[:]  
        
        aeps_runsdf120_1INS_DR[nfr]=perf_metrdf1_aepsdr120s[:] 
        aeps_runsdf120_2INS_DR[nfr]=perf_metrdf2_aepsdr120s[:]        
        aeps_runsdf120_3INS_DR[nfr]=perf_metrdf3_aepsdr120s[:] 
        
        aeps_runsdf180_1INS_DR[nfr]=perf_metrdf1_aepsdr180s[:] 
        aeps_runsdf180_2INS_DR[nfr]=perf_metrdf2_aepsdr180s[:]        
        aeps_runsdf180_3INS_DR[nfr]=perf_metrdf3_aepsdr180s[:]   
...
#    aag030_7INS_DR=np.amin(crse_runsag30_7INS_DR,axis=0)      
...
#    aag060_7INS_DR=np.amin(crse_runsag60_7INS_DR,axis=0)  
...
#    aag090_7INS_DR=np.amin(crse_runsag90_7INS_DR,axis=0)  
...
#    aag120_7INS_DR=np.amin(crse_runsag120_7INS_DR,axis=0)
...
#    aag180_7INS_DR=np.amin(crse_runsag180_7INS_DR,axis=0)
...
#    dag030_7NN=np.amin(cae_runsag30_7NN,axis=0)
...
#    dag060_7NN=np.amin(cae_runsag60_7NN,axis=0)
...
#    dag090_7NN=np.amin(cae_runsag90_7NN,axis=0)
...
#    dag120_7NN=np.amin(cae_runsag120_7NN,axis=0)
...
#    dag180_7NN=np.amin(cae_runsag180_7NN,axis=0)
...
#    dag030_7INS_DR=np.amin(cae_runsag30_7INS_DR,axis=0)      
...
#    dag060_7INS_DR=np.amin(cae_runsag60_7INS_DR,axis=0)  
...
#    dag090_7INS_DR=np.amin(cae_runsag90_7INS_DR,axis=0) 
...
#    dag120_7INS_DR=np.amin(cae_runsag120_7INS_DR,axis=0)
...
#    dag180_7INS_DR=np.amin(cae_runsag180_7INS_DR,axis=0)
    ...
    lhrNN=np.amin(aeps_runshrNN,axis=0)
    
    lra_1NN=np.amin(aeps_runsra_1NN,axis=0)
    lra_2NN=np.amin(aeps_runsra_2NN,axis=0)
    
    lcia_1NN=np.amin(aeps_runscia_1NN,axis=0)
    lcia_2NN=np.amin(aeps_runscia_2NN,axis=0)
    
    lhb_1NN=np.amin(aeps_runshb_1NN,axis=0)
    lhb_2NN=np.amin(aeps_runshb_2NN,axis=0)
       
    lslr_1NN=np.amin(aeps_runsslr_1NN,axis=0)
    lslr_2NN=np.amin(aeps_runsslr_2NN,axis=0)
    lslr_3NN=np.amin(aeps_runsslr_3NN,axis=0)
    
    lwr_1NN=np.amin(aeps_runswr_1NN,axis=0)
    lwr_2NN=np.amin(aeps_runswr_2NN,axis=0)
    lwr_3NN=np.amin(aeps_runswr_3NN,axis=0)
    
    lag030_1NN=np.amin(aeps_runsag30_1NN,axis=0)
    lag030_2NN=np.amin(aeps_runsag30_2NN,axis=0)
    lag030_3NN=np.amin(aeps_runsag30_3NN,axis=0)
    lag030_4NN=np.amin(aeps_runsag30_4NN,axis=0)
    lag030_5NN=np.amin(aeps_runsag30_5NN,axis=0)
    lag030_6NN=np.amin(aeps_runsag30_6NN,axis=0)
#    lag030_7NN=np.amin(aeps_runsag30_7NN,axis=0)
    
    lag060_1NN=np.amin(aeps_runsag60_1NN,axis=0)
    lag060_2NN=np.amin(aeps_runsag60_2NN,axis=0)
    lag060_3NN=np.amin(aeps_runsag60_3NN,axis=0)
    lag060_4NN=np.amin(aeps_runsag60_4NN,axis=0)
    lag060_5NN=np.amin(aeps_runsag60_5NN,axis=0)
    lag060_6NN=np.amin(aeps_runsag60_6NN,axis=0)
#    lag060_7NN=np.amin(aeps_runsag60_7NN,axis=0)
    
    lag090_1NN=np.amin(aeps_runsag90_1NN,axis=0)
    lag090_2NN=np.amin(aeps_runsag90_2NN,axis=0)
    lag090_3NN=np.amin(aeps_runsag90_3NN,axis=0)
    lag090_4NN=np.amin(aeps_runsag90_4NN,axis=0)
    lag090_5NN=np.amin(aeps_runsag90_5NN,axis=0)
    lag090_6NN=np.amin(aeps_runsag90_6NN,axis=0)
#    lag090_7NN=np.amin(aeps_runsag90_7NN,axis=0)
    
    lag120_1NN=np.amin(aeps_runsag120_1NN,axis=0)
    lag120_2NN=np.amin(aeps_runsag120_2NN,axis=0)
    lag120_3NN=np.amin(aeps_runsag120_3NN,axis=0)
    lag120_4NN=np.amin(aeps_runsag120_4NN,axis=0)
    lag120_5NN=np.amin(aeps_runsag120_5NN,axis=0)
    lag120_6NN=np.amin(aeps_runsag120_6NN,axis=0)
#    lag120_7NN=np.amin(aeps_runsag120_7NN,axis=0)
    
    lag180_1NN=np.amin(aeps_runsag180_1NN,axis=0)
    lag180_2NN=np.amin(aeps_runsag180_2NN,axis=0)
    lag180_3NN=np.amin(aeps_runsag180_3NN,axis=0)
    lag180_4NN=np.amin(aeps_runsag180_4NN,axis=0)
    lag180_5NN=np.amin(aeps_runsag180_5NN,axis=0)
    lag180_6NN=np.amin(aeps_runsag180_6NN,axis=0)
#    lag180_7NN=np.amin(aeps_runsag180_7NN,axis=0)
    
    ldf030_1NN=np.amin(aeps_runsdf30_1NN,axis=0)
    ldf030_2NN=np.amin(aeps_runsdf30_2NN,axis=0)
    ldf030_3NN=np.amin(aeps_runsdf30_3NN,axis=0)
    
    ldf060_1NN=np.amin(aeps_runsdf60_1NN,axis=0)
    ldf060_2NN=np.amin(aeps_runsdf60_2NN,axis=0)
    ldf060_3NN=np.amin(aeps_runsdf60_3NN,axis=0)
    
    ldf090_1NN=np.amin(aeps_runsdf90_1NN,axis=0)
    ldf090_2NN=np.amin(aeps_runsdf90_2NN,axis=0)
    ldf090_3NN=np.amin(aeps_runsdf90_3NN,axis=0)
    
    ldf120_1NN=np.amin(aeps_runsdf120_1NN,axis=0)
    ldf120_2NN=np.amin(aeps_runsdf120_2NN,axis=0)
    ldf120_3NN=np.amin(aeps_runsdf120_3NN,axis=0)
    
    ldf180_1NN=np.amin(aeps_runsdf180_1NN,axis=0)
    ldf180_2NN=np.amin(aeps_runsdf180_2NN,axis=0)
    ldf180_3NN=np.amin(aeps_runsdf180_3NN,axis=0)
    
    lhrINS_DR=np.amin(aeps_runshrINS_DR,axis=0)
    
    lra_1INS_DR=np.amin(aeps_runsra_1INS_DR,axis=0)
    lra_2INS_DR=np.amin(aeps_runsra_2INS_DR,axis=0)
    
    lcia_1INS_DR=np.amin(aeps_runscia_1INS_DR,axis=0)
    lcia_2INS_DR=np.amin(aeps_runscia_2INS_DR,axis=0)
    
    
    lhb_1INS_DR=np.amin(aeps_runshb_1INS_DR,axis=0)
    lhb_2INS_DR=np.amin(aeps_runshb_2INS_DR,axis=0)
    
    lslr_1INS_DR=np.amin(aeps_runsslr_1INS_DR,axis=0)
    lslr_2INS_DR=np.amin(aeps_runsslr_2INS_DR,axis=0)
    lslr_3INS_DR=np.amin(aeps_runsslr_3INS_DR,axis=0)
    
    lwr_1INS_DR=np.amin(aeps_runswr_1INS_DR,axis=0)
    lwr_2INS_DR=np.amin(aeps_runswr_2INS_DR,axis=0)
    lwr_3INS_DR=np.amin(aeps_runswr_3INS_DR,axis=0)
    
    lag030_1INS_DR=np.amin(aeps_runsag30_1INS_DR,axis=0)
    lag030_2INS_DR=np.amin(aeps_runsag30_2INS_DR,axis=0)
    lag030_3INS_DR=np.amin(aeps_runsag30_3INS_DR,axis=0)
    lag030_4INS_DR=np.amin(aeps_runsag30_4INS_DR,axis=0)
    lag030_5INS_DR=np.amin(aeps_runsag30_5INS_DR,axis=0)    
    lag030_6INS_DR=np.amin(aeps_runsag30_6INS_DR,axis=0)
#    lag030_7INS_DR=np.amin(aeps_runsag30_7INS_DR,axis=0)      
    
    lag060_1INS_DR=np.amin(aeps_runsag60_1INS_DR,axis=0)
    lag060_2INS_DR=np.amin(aeps_runsag60_2INS_DR,axis=0)    
    lag060_3INS_DR=np.amin(aeps_runsag60_3INS_DR,axis=0)    
    lag060_4INS_DR=np.amin(aeps_runsag60_4INS_DR,axis=0)
    lag060_5INS_DR=np.amin(aeps_runsag60_5INS_DR,axis=0)    
    lag060_6INS_DR=np.amin(aeps_runsag60_6INS_DR,axis=0)    
#    lag060_7INS_DR=np.amin(aeps_runsag60_7INS_DR,axis=0)  
    
    lag090_1INS_DR=np.amin(aeps_runsag90_1INS_DR,axis=0)
    lag090_2INS_DR=np.amin(aeps_runsag90_2INS_DR,axis=0)    
    lag090_3INS_DR=np.amin(aeps_runsag90_3INS_DR,axis=0)
    lag090_4INS_DR=np.amin(aeps_runsag90_4INS_DR,axis=0)
    lag090_5INS_DR=np.amin(aeps_runsag90_5INS_DR,axis=0)
    lag090_6INS_DR=np.amin(aeps_runsag90_6INS_DR,axis=0)    
#    lag090_7INS_DR=np.amin(aeps_runsag90_7INS_DR,axis=0)  
    
    lag120_1INS_DR=np.amin(aeps_runsag120_1INS_DR,axis=0)
    lag120_2INS_DR=np.amin(aeps_runsag120_2INS_DR,axis=0)
    lag120_3INS_DR=np.amin(aeps_runsag120_3INS_DR,axis=0)
    lag120_4INS_DR=np.amin(aeps_runsag120_4INS_DR,axis=0)
    lag120_5INS_DR=np.amin(aeps_runsag120_5INS_DR,axis=0)
    lag120_6INS_DR=np.amin(aeps_runsag120_6INS_DR,axis=0)
#    lag120_7INS_DR=np.amin(aeps_runsag120_7INS_DR,axis=0)
    
    lag180_1INS_DR=np.amin(aeps_runsag180_1INS_DR,axis=0)
    lag180_2INS_DR=np.amin(aeps_runsag180_2INS_DR,axis=0)
    lag180_3INS_DR=np.amin(aeps_runsag180_3INS_DR,axis=0)
    lag180_4INS_DR=np.amin(aeps_runsag180_4INS_DR,axis=0)
    lag180_5INS_DR=np.amin(aeps_runsag180_5INS_DR,axis=0)
    lag180_6INS_DR=np.amin(aeps_runsag180_6INS_DR,axis=0)
#    lag180_7INS_DR=np.amin(aeps_runsag180_7INS_DR,axis=0)
    
    ldf030_1INS_DR=np.amin(aeps_runsdf30_1INS_DR,axis=0)
    ldf030_2INS_DR=np.amin(aeps_runsdf30_2INS_DR,axis=0)    
    ldf030_3INS_DR=np.amin(aeps_runsdf30_3INS_DR,axis=0)    
     
    ldf060_1INS_DR=np.amin(aeps_runsdf60_1INS_DR,axis=0)
    ldf060_2INS_DR=np.amin(aeps_runsdf60_2INS_DR,axis=0)   
    ldf060_3INS_DR=np.amin(aeps_runsdf60_3INS_DR,axis=0)   
    
    ldf090_1INS_DR=np.amin(aeps_runsdf90_1INS_DR,axis=0)
    ldf090_2INS_DR=np.amin(aeps_runsdf90_2INS_DR,axis=0)  
    ldf090_3INS_DR=np.amin(aeps_runsdf90_3INS_DR,axis=0)  
    
    ldf120_1INS_DR=np.amin(aeps_runsdf120_1INS_DR,axis=0)
    ldf120_2INS_DR=np.amin(aeps_runsdf120_2INS_DR,axis=0)   
    ldf120_3INS_DR=np.amin(aeps_runsdf120_3INS_DR,axis=0) 
    
    ldf180_1INS_DR=np.amin(aeps_runsdf180_1INS_DR,axis=0)
    ldf180_2INS_DR=np.amin(aeps_runsdf180_2INS_DR,axis=0)   
    ldf180_3INS_DR=np.amin(aeps_runsdf180_3INS_DR,axis=0)     
...
#    braINS_DR=np.concatenate((np.reshape(ara_1INS_DR,(4,1)),np.reshape(ahb_2INS_DR,(4,1))),axis=0)  
...
#    ehbINS_DR=np.reshape(dhrINS_DR,(4,1)) 
...
#    eraINS_DR=np.concatenate((np.reshape(dra_1INS_DR,(4,1)),np.reshape(dra_2INS_DR,(4,1))),axis=0)  
    ...
    mhrNN=np.reshape(lhrNN,(4,1))  
    mraNN=np.concatenate((np.reshape(lra_1NN,(4,1)),np.reshape(lra_2NN,(4,1))),axis=0)  
    mciaNN=np.concatenate((np.reshape(lcia_1NN,(4,1)),np.reshape(lcia_2NN,(4,1))),axis=0)  
    mhbNN=np.concatenate((np.reshape(lhb_1NN,(4,1)),np.reshape(lhb_2NN,(4,1))),axis=0)  
    mslrNN=np.concatenate((np.reshape(lslr_1NN,(4,1)),np.reshape(lslr_2NN,(4,1)),np.reshape(lslr_3NN,(4,1))),axis=0)  
    mwrNN=np.concatenate((np.reshape(lwr_1NN,(4,1)),np.reshape(lwr_2NN,(4,1)),np.reshape(lwr_3NN,(4,1))),axis=0)  
    m030NN=np.concatenate((np.reshape(lag030_1NN,(4,1)),np.reshape(lag030_2NN,(4,1)),np.reshape(lag030_3NN,(4,1)),np.reshape(lag030_4NN,(4,1)),np.reshape(lag030_5NN,(4,1)),np.reshape(lag030_6NN,(4,1)),np.reshape(ldf030_1NN,(4,1)),np.reshape(ldf030_2NN,(4,1)),np.reshape(ldf030_3NN,(4,1))),axis=0)  
    m060NN=np.concatenate((np.reshape(lag060_1NN,(4,1)),np.reshape(lag060_2NN,(4,1)),np.reshape(lag060_3NN,(4,1)),np.reshape(lag060_4NN,(4,1)),np.reshape(lag060_5NN,(4,1)),np.reshape(lag060_6NN,(4,1)),np.reshape(ldf060_1NN,(4,1)),np.reshape(ldf060_2NN,(4,1)),np.reshape(ldf060_3NN,(4,1))),axis=0) 
    m120NN=np.concatenate((np.reshape(lag120_1NN,(4,1)),np.reshape(lag120_2NN,(4,1)),np.reshape(lag120_3NN,(4,1)),np.reshape(lag120_4NN,(4,1)),np.reshape(lag120_5NN,(4,1)),np.reshape(lag120_6NN,(4,1)),np.reshape(ldf120_1NN,(4,1)),np.reshape(ldf120_2NN,(4,1)),np.reshape(ldf120_3NN,(4,1))),axis=0) 
    m180NN=np.concatenate((np.reshape(lag180_1NN,(4,1)),np.reshape(lag180_2NN,(4,1)),np.reshape(lag180_3NN,(4,1)),np.reshape(lag180_4NN,(4,1)),np.reshape(lag180_5NN,(4,1)),np.reshape(lag180_6NN,(4,1)),np.reshape(ldf180_1NN,(4,1)),np.reshape(ldf180_2NN,(4,1)),np.reshape(ldf180_3NN,(4,1))),axis=0) 
   
    mhbINS_DR=np.concatenate((np.reshape(lhb_1INS_DR,(4,1)),np.reshape(lhb_2INS_DR,(4,1))),axis=0)  
    mhrINS_DR=np.reshape(lhrINS_DR,(4,1))  
    mraINS_DR=np.concatenate((np.reshape(lra_1INS_DR,(4,1)),np.reshape(lra_2INS_DR,(4,1))),axis=0)  
    mciaINS_DR=np.concatenate((np.reshape(lcia_1INS_DR,(4,1)),np.reshape(lcia_2INS_DR,(4,1))),axis=0)  
    mraINS_DR=np.concatenate((np.reshape(lhb_1INS_DR,(4,1)),np.reshape(lhb_2INS_DR,(4,1))),axis=0)  
    mslrINS_DR=np.concatenate((np.reshape(lslr_1INS_DR,(4,1)),np.reshape(lslr_2INS_DR,(4,1)),np.reshape(lslr_3INS_DR,(4,1))),axis=0)  
    mwrINS_DR=np.concatenate((np.reshape(lwr_1INS_DR,(4,1)),np.reshape(lwr_2INS_DR,(4,1)),np.reshape(lwr_3INS_DR,(4,1))),axis=0)  
    m030INS_DR=np.concatenate((np.reshape(lag030_1INS_DR,(4,1)),np.reshape(lag030_2INS_DR,(4,1)),np.reshape(lag030_3INS_DR,(4,1)),np.reshape(lag030_4INS_DR,(4,1)),np.reshape(lag030_5INS_DR,(4,1)),np.reshape(lag030_6INS_DR,(4,1)),np.reshape(ldf030_1INS_DR,(4,1)),np.reshape(ldf030_2INS_DR,(4,1)),np.reshape(ldf030_3INS_DR,(4,1))),axis=0)  
    m060INS_DR=np.concatenate((np.reshape(lag060_1INS_DR,(4,1)),np.reshape(lag060_2INS_DR,(4,1)),np.reshape(lag060_3INS_DR,(4,1)),np.reshape(lag060_4INS_DR,(4,1)),np.reshape(lag060_5INS_DR,(4,1)),np.reshape(lag060_6INS_DR,(4,1)),np.reshape(ldf060_1INS_DR,(4,1)),np.reshape(ldf060_2INS_DR,(4,1)),np.reshape(ldf060_3INS_DR,(4,1))),axis=0) 
    m120INS_DR=np.concatenate((np.reshape(lag120_1INS_DR,(4,1)),np.reshape(lag120_2INS_DR,(4,1)),np.reshape(lag120_3INS_DR,(4,1)),np.reshape(lag120_4INS_DR,(4,1)),np.reshape(lag120_5INS_DR,(4,1)),np.reshape(lag120_6INS_DR,(4,1)),np.reshape(ldf120_1INS_DR,(4,1)),np.reshape(ldf120_2INS_DR,(4,1)),np.reshape(ldf120_3INS_DR,(4,1))),axis=0)    
    m180INS_DR=np.concatenate((np.reshape(lag180_1INS_DR,(4,1)),np.reshape(lag180_2INS_DR,(4,1)),np.reshape(lag180_3INS_DR,(4,1)),np.reshape(lag180_4INS_DR,(4,1)),np.reshape(lag180_5INS_DR,(4,1)),np.reshape(lag180_6INS_DR,(4,1)),np.reshape(ldf180_1INS_DR,(4,1)),np.reshape(ldf180_2INS_DR,(4,1)),np.reshape(ldf180_3INS_DR,(4,1))),axis=0)    

    
    'hyperparameter optimisation result logging'    
    opt_runshrNN[0,opt_,:4]=ahrNN# motorway
    
    opt_runsraNN[0,opt_,:4]=ara_1NN#roundabout
    opt_runsraNN[1,opt_,:4]=ara_2NN#roundabout
    
    opt_runsciaNN[0,opt_,:4]=acia_1NN#quick changes in acceleration
    opt_runsciaNN[1,opt_,:4]=acia_2NN#quick changes in acceleration
    
    opt_runshbNN[0,opt_,:4]=ahb_1NN#hard brake
    opt_runshbNN[1,opt_,:4]=ahb_2NN#hard brake
    
    opt_runsslrNN[0,opt_,:4]=aslr_1NN#successive left and right turns   
    opt_runsslrNN[1,opt_,:4]=aslr_2NN#successive left and right turns   
    opt_runsslrNN[2,opt_,:4]=aslr_3NN#successive left and right turns   
    
    opt_runswrNN[0,opt_,:4]=awr_1NN# wet road
    opt_runswrNN[1,opt_,:4]=awr_2NN# wet road
    opt_runswrNN[2,opt_,:4]=awr_3NN# wet road
    
    opt_runsag030NN[0,opt_,:4]=aag030_1NN# aggressive driving
    opt_runsag030NN[1,opt_,:4]=aag030_2NN# aggressive driving
    opt_runsag030NN[2,opt_,:4]=aag030_3NN# aggressive driving
    opt_runsag030NN[3,opt_,:4]=aag030_4NN# aggressive driving
    opt_runsag030NN[4,opt_,:4]=aag030_5NN# aggressive driving
    opt_runsag030NN[5,opt_,:4]=aag030_6NN# aggressive driving
#    opt_runsag030NN[6,opt_,:4]=aag030_7NN# aggressive driving
    
    opt_runsag060NN[0,opt_,:4]=aag060_1NN
    opt_runsag060NN[1,opt_,:4]=aag060_2NN
    opt_runsag060NN[2,opt_,:4]=aag060_3NN
    opt_runsag060NN[3,opt_,:4]=aag060_4NN
    opt_runsag060NN[4,opt_,:4]=aag060_5NN
    opt_runsag060NN[5,opt_,:4]=aag060_6NN
#    opt_runsag060NN[6,opt_,:4]=aag060_7NN
    
    opt_runsag180NN[0,opt_,:4]=aag180_1NN
    opt_runsag180NN[1,opt_,:4]=aag180_2NN
    opt_runsag180NN[2,opt_,:4]=aag180_3NN
    opt_runsag180NN[3,opt_,:4]=aag180_4NN    
    opt_runsag180NN[4,opt_,:4]=aag180_5NN
    opt_runsag180NN[5,opt_,:4]=aag180_6NN
#    opt_runsag180NN[6,opt_,:4]=aag180_7NN    
    
    opt_runsag120NN[0,opt_,:4]=aag120_1NN
    opt_runsag120NN[1,opt_,:4]=aag120_2NN
    opt_runsag120NN[2,opt_,:4]=aag120_3NN
    opt_runsag120NN[3,opt_,:4]=aag120_4NN
    opt_runsag120NN[4,opt_,:4]=aag120_5NN
    opt_runsag120NN[5,opt_,:4]=aag120_6NN
#    opt_runsag120NN[6,opt_,:4]=aag120_7NN
    
    opt_runsdf030NN[0,opt_,:4]=adf030_1NN# defensive driving
    opt_runsdf030NN[1,opt_,:4]=adf030_2NN# defensive driving
    opt_runsdf030NN[2,opt_,:4]=adf030_3NN# defensive driving
    
    opt_runsdf060NN[0,opt_,:4]=adf060_1NN
    opt_runsdf060NN[1,opt_,:4]=adf060_2NN
    opt_runsdf060NN[2,opt_,:4]=adf060_3NN
    
    opt_runsdf180NN[0,opt_,:4]=adf180_1NN
    opt_runsdf180NN[1,opt_,:4]=adf180_2NN
    opt_runsdf180NN[2,opt_,:4]=adf180_3NN
    
    opt_runsdf120NN[0,opt_,:4]=adf120_1NN
    opt_runsdf120NN[1,opt_,:4]=adf120_2NN
    opt_runsdf120NN[2,opt_,:4]=adf120_3NN